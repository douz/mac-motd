...
grep -q 'GPU Temp+\.\.:.*47\.10°C' "$OUTPUT_INTEL"
grep -q 'Mem Temp\.\.\.:.*41\.30°C' "$OUTPUT_INTEL"
grep -q 'Mem Temp+\.\.:.*40\.80°C' "$OUTPUT_INTEL"
...
grep -q 'GPU Temp+\.\.:.*58\.40°C' "$OUTPUT_SILICON"
grep -q 'Mem Temp\.\.\.:.*44\.40°C' "$OUTPUT_SILICON"
grep -q 'Mem Temp+\.\.:.*42\.20°C' "$OUTPUT_SILICON"
